...
| 5 | `js/cos-data.js` | 純データ＋IIFE | COS_DATA/COS_SLOTS/RARITY/SETS/TITLES（コスチューム330種・hero/pet/aibou） | なし |
| 5b | `js/gacha-story.js` | 純データ＋関数 | ガチャ世界観（行商人たぬすけ/週替わりピックアップ/セット完成ストーリー/lore） | **5 の後**（COS_SETS を参照） |
