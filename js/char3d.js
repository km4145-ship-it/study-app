...
var MON3D_SPECS = {
  ...
  // 新規Batch5
  ebi:       { plan:'beast',   main:'#fb923c', belly:'#fed7aa', eye:'#0f172a' },
  hachi:     { plan:'blob',    main:'#fcd34d', hi:'#fef3c7', eye:'#0f172a' },
  ari:       { plan:'blob',    main:'#9a3412', hi:'#c2410c', eye:'#0f172a' },
  ika:       { plan:'blob',    main:'#fbcfe8', hi:'#fce7f3', eye:'#0f172a' },
  kuroneko:  { plan:'beast',   main:'#1e293b', belly:'#334155', eye:'#4ade80' },
  fukurou:   { plan:'bird',    main:'#92400e', belly:'#fef3c7', beak:'#fbbf24', eye:'#fff', pupil:'#0f172a' },
  chou:      { plan:'blob',    main:'#a78bfa', hi:'#c4b5fd', eye:'#0f172a' },
  kappa:     { plan:'blob',    main:'#84cc16', hi:'#bef264', eye:'#0f172a' },
  oni:       { plan:'beast',   main:'#3b82f6', belly:'#93c5fd', eye:'#dc2626' },
  tengu:     { plan:'beast',   main:'#dc2626', belly:'#fca5a5', eye:'#0f172a' },
  umihebi:   { plan:'dragon',  main:'#38bdf8', belly:'#bae6fd', horn:'#0ea5e9', wing:'#0369a1', eye:'#fff', pupil:'#0c4a6e' },
  kurisu:    { plan:'golem',   main:'#a5f3fc', hole:'#0891b2' },
  // 新規Batch6（図鑑500種到達）
  saru:      { plan:'beast',   main:'#a8895f', belly:'#fde8d0', eye:'#0f172a' },
  shika:     { plan:'beast',   main:'#c2724a', belly:'#f5e6d0', eye:'#0f172a' },
  kujira:    { plan:'beast',   main:'#3b82f6', belly:'#bfdbfe', eye:'#0f172a' },
  denki:     { plan:'beast',   main:'#fde047', belly:'#fef9c3', eye:'#0f172a' },
  pega:      { plan:'beast',   main:'#f8fafc', belly:'#e0e7ff', eye:'#0f172a' },
  kabocha:   { plan:'blob',    main:'#f97316', hi:'#fdba74', eye:'#7c2d12' },
  magma:     { plan:'golem',   main:'#292524', hole:'#f97316' },
  seiryu:    { plan:'dragon',  main:'#06b6d4', belly:'#a5f3fc', horn:'#67e8f9', wing:'#0e7490', eye:'#fff', pupil:'#164e63' },
