...
var COS_TITLES={
  ...
  // ===== 実績（学習・冒険のマイルストーン）で もらえる称号 =====
  a_start:{ name:'まなびの たまご', em:'🥚' },        // はじめて問題を解いた
  a_streak3:{ name:'3日 つづいた', em:'🔥' },         // 3日連続
  a_streak7:{ name:'1しゅうかんの 勇者', em:'📅' },   // 7日連続
  a_streak30:{ name:'30日の でんせつ', em:'🏆' },     // 30日連続
  a_ans100:{ name:'100もん とっぱ', em:'💯' },        // 通算100問
  a_ans1000:{ name:'1000もんの つわもの', em:'🎓' },  // 通算1000問
  a_jitsu55:{ name:'じつりょく55', em:'📈' },         // じつりょく55
  a_jitsu65:{ name:'偏差値65の かべごえ', em:'⭐' },  // じつりょく65
  a_crystal:{ name:'クリスタルマスター', em:'💎' },    // クリスタル5つ
  a_maou:{ name:'魔王を たおした者', em:'👑' },        // 魔王シグマ撃破
  a_scout:{ name:'モンスターはかせ', em:'📖' }         // なかま図鑑30種
};
// アイテムidから中身を引く（レア度など）
