...
// ===== 大陸ストーリーアーク（手書き）：各大陸の 起（1章）・転（5章）・結（10章）だけ
// 自動生成の1行を物語シーンで上書きする（↑のIIFEの後で代入＝上書きが効く） =====
(function(){
  var ARCS={
    math_ch1:[
      { who:'ミミ学園長', char:'owl', text:'ここが「数の大陸」。魔王シグマが 最初に おそった場所よ。' },
      { who:'ミミ学園長', char:'owl', text:'計算の力が うばわれると、お店も 時計も みんな こまってしまうの。' },
      { who:'', char:'scroll', text:'—— 1問ずつ、たしかめながら。それが 数の大陸の あるきかた。' } ],
    math_ch5:[
      { who:'？？？', char:'villain', text:'クックック…ここまで来たか。だが 数の迷宮は これからが 本番だ。' },
      { who:'ミミ学園長', char:'owl', text:'まどわされないで！ むずかしく見える問題ほど、じゅんばんに 分ければ かんたんになるわ。' } ],
    math_ch10:[
      { who:'ミミ学園長', char:'owl', text:'大陸の おくに、数の先生が とらわれている…この章のボスを たおせば たすけられる！' },
      { who:'たぬすけ（行商人）', char:'merchant', text:'ここまでの きみの計算、わしが ほしょうする。自信をもって いってこい！' },
      { who:'', char:'scroll', text:'—— クリスタルが、きみの答えを まっている。' } ],
    japanese_ch1:[
      { who:'ミミ学園長', char:'owl', text:'「ことばの大陸」へ ようこそ。ここでは ことばが 力になるの。' },
      { who:'', char:'scroll', text:'—— 漢字も ことわざも、むかしの人からの 手紙のようなもの。' } ],
    japanese_ch5:[
      { who:'？？？', char:'villain', text:'フン…ことばなど なくても こまらぬわ。' },
      { who:'ミミ学園長', char:'owl', text:'いいえ。つたえたい気持ちが あるかぎり、ことばは 消えないわ。見せてあげましょう！' } ],
    japanese_ch10:[
      { who:'ミミ学園長', char:'owl', text:'ことばの先生の 声が きこえる…！ もうすこしよ！' },
      { who:'', char:'scroll', text:'—— 読みとる力は、こころを つなぐ力。さいごの章、はじまり。' } ],
    english_ch1:[
      { who:'ミミ学園長', char:'owl', text:'「アルファベット大陸」よ。海のむこうの ことばが ねむる場所。' },
      { who:'たぬすけ（行商人）', char:'merchant', text:'わしも 行商で 英語には たすけられたぞ。Hello の ひとことが 旅の とびらじゃ。' } ],
    english_ch5:[
      { who:'？？？', char:'villain', text:'発音も 文法も バラバラに してくれたわ…もう だれも 話せまい。' },
      { who:'ミミ学園長', char:'owl', text:'だいじょうぶ。主語と動詞…じゅんばんを 思い出せば、文は よみがえる！' } ],
    english_ch10:[
      { who:'ミミ学園長', char:'owl', text:'英語の先生が まっているわ。せかいと つながる とびらを とりもどして！' },
      { who:'', char:'scroll', text:'—— きみの英語は、もう 旅の どうぐだ。' } ],
    science_ch1:[
      { who:'ミミ学園長', char:'owl', text:'「じっけんの大陸」…！ ここは ふしぎが いっぱいの場所よ。' },
      { who:'', char:'scroll', text:'—— 「なぜ？」と 思ったら、それが 実験の はじまり。' } ],
    science_ch5:[
      { who:'？？？', char:'villain', text:'理科など まやかしだ。世界の しくみなど 知らなくてよい。' },
      { who:'ミミ学園長', char:'owl', text:'知ることは 力よ。光も 電気も 生き物も…しくみが わかれば こわくない！' } ],
    science_ch10:[
      { who:'ミミ学園長', char:'owl', text:'理科の先生の 研究室は この おく。かがくの クリスタルを とりもどそう！' },
      { who:'', char:'scroll', text:'—— 観察、予想、たしかめ。きみは もう 小さな科学者だ。' } ],
    social_ch1:[
      { who:'ミミ学園長', char:'owl', text:'「れきしの大陸」へ ようこそ。時の流れが ねむる場所よ。' },
      { who:'', char:'scroll', text:'—— きのうを 知る者だけが、あしたを えらべる。' } ],
    social_ch5:[
      { who:'？？？', char:'villain', text:'歴史など けせばよい。だれも むかしを おぼえていなければ、わしが 歴史に なる。' },
      { who:'ミミ学園長', char:'owl', text:'させないわ！ 地図と年表…人々の あゆみは、けっして きえない！' } ],
    social_ch10:[
      { who:'ミミ学園長', char:'owl', text:'社会の先生が この先に！ さいごの クリスタルまで あと一歩よ！' },
      { who:'たぬすけ（行商人）', char:'merchant', text:'5つ そろえば 魔王城の 扉がひらく…歴史が うごく しゅんかんじゃ。' } ]
  };
  Object.keys(ARCS).forEach(function(k){ RPG_STORY[k]=ARCS[k]; });
})();
