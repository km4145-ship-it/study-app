...
[
  ...
  'js/subjects.js', 'js/questions-bank.js', 'js/questions-extra.js', 'js/generators.js', 'js/generators-hard.js', 'js/generators-plus.js', 'js/generators-listen.js',
  'js/audio.js', 'js/furigana.js', 'js/reading-ja.js', 'js/content-data.js', 'js/scoring.js',
  'js/ui-data.js', 'js/util.js', 'js/miss-types.js', 'js/coverage.js', 'js/rating.js', 'js/teach.js', 'js/reading-data.js', 'js/duel.js', 'js/ranking.js', 'js/gacha-story.js', 'js/three.min.js', 'js/char3d.js', 'cloud-sync.js',
