...
[
  ...
  'js/ui-data.js', 'js/util.js', 'js/miss-types.js', 'js/coverage.js', 'js/rating.js', 'js/teach.js', 'js/duel.js', 'js/ranking.js', 'js/gacha-story.js', 'js/three.min.js', 'js/char3d.js', 'cloud-sync.js',
